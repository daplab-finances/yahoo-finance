...
import it.daplab.finance.yahoo.quotes.fx.FxQuote;
import it.daplab.finance.yahoo.quotes.fx.FxQuotesRequest;
import it.daplab.finance.yahoo.quotes.stock.StockQuotesData;
import it.daplab.finance.yahoo.quotes.stock.StockQuotesRequest;
...
public class YahooFinance {
    ...
    /**
    * Sends a basic quotes request to Yahoo Finance. This will return a {@link it.daplab.finance.yahoo.Stock} object
    * with its {@link it.daplab.finance.yahoo.quotes.stock.StockQuote}, {@link it.daplab.finance.yahoo.quotes.stock.StockStats}
    * and {@link it.daplab.finance.yahoo.quotes.stock.StockDividend} member fields
    ...
    * @return           a {@link it.daplab.finance.yahoo.Stock} object containing the requested information
    ...
    */
     ...
     * historical stock quote data. Including historical data will cause the {@link it.daplab.finance.yahoo.Stock}
     * object's member field {@link it.daplab.finance.yahoo.histquotes.HistoricalQuote} to be filled in
    ...
    * The Stock objects have their {@link it.daplab.finance.yahoo.quotes.stock.StockQuote}, {@link it.daplab.finance.yahoo.quotes.stock.StockStats}
    * and {@link it.daplab.finance.yahoo.quotes.stock.StockDividend} member fields
    * filled in with the available data.
    * <p>
    ...
    */
     ...
     * objects their member field {@link it.daplab.finance.yahoo.histquotes.HistoricalQuote} to be filled in
     * with the default past year term at monthly intervals.
     * <p>
     ...
     * Some common symbols can easily be found in the ENUM {@link it.daplab.finance.yahoo.quotes.fx.FxSymbols}
